...
function updateUser(data) {
  return (dispatch) => {
    ...
    let url = `/userRoles/user/${data.path.userId}`
    AxiosAPI.put(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function updateUserPass(data) {
  return (dispatch) => {
    ...
    let url = `/userRoles/user/${data.path.userId}/pass`
    AxiosAPI.put(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function updateUserRole(data) {
  return (dispatch) => {
    ...
    let url = `/userRoles/user/${data.path.userId}/bindRole`
    AxiosAPI.put(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function updateRole(data) {
  return (dispatch) => {
    ...
    let url = `/userRoles/role/${data.path.roleId}`
    AxiosAPI.put(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function fetchRoleMenus(data) {
  return (dispatch) => {
    ...
    let url = `/userRoles/role/${data.path.roleId}/permission`
    AxiosAPI.get(
      url, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function createMenu(data) {
  return (dispatch) => {
    ...
    let url = `/permissions/menu/${data.path.parentId}`
    AxiosAPI.post(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function updateMenu(data) {
  return (dispatch) => {
    ...
    let url = `/permissions/menus/${data.path.menuId}`
    AxiosAPI.put(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function updateMenuRoute(data) {
  return (dispatch) => {
    ...
    let url = `/permissions/menuRoute/${data.path.permissionId}`
    AxiosAPI.put(
      url, data.form, {
        headers: {
          'adminUserId': JSON.parse(sessionStorage.getItem('hoolai')).userId,
...
function updateLimit(value) {
  return (dispatch) => {
    ...
    let url = `/userRoles/role/${value.roleId}/permission/limit`
    AxiosAPI.put(
